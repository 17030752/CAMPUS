...
<head>
    ...
    <title>Campus Virtual | Batería para Conductores - Bloque 3</title>
    <style>
        body  {
...
<body>
    <div class="container">
        ...
        <div class="row" align="center" style="background-color: #FFFFFF;">
            ...
            <br>
            <h3 style="background-color: #FFFFFF;">Bloque 3</h3>
        </div>
        <div class="row" style="background-color: #FFFFFF;">
            <div class="col-sm-12">
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center d-grid gap-2">
							<a href="bateria_bloq_3.php" class="trigger-btn btn btn-primary">Siguiente</a>
							</br>
						</div>
                    </div>
                </div>
